...
docker run -d -p 8080:8080 --name my-container-name aiyaraaiya/go-docker_multi_stage:v1.0
docker run -d -p 8080:8080 --name go-docker_multi_stage_v_1_0 aiyaraaiya/go-docker_multi_stage:v1.0
```
```
Alpine
